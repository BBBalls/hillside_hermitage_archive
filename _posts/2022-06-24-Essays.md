...
(according to the <span lang="pi">*Suttas*</span>).[^139] That is why,
if mindfulness and awareness is practised correctly, it will result in
...
background that’s simultaneous with the presently arisen
phenomenon[^140], results in the establishment of mind
(<span lang="pi">*samadhi*</span>) that transcends *sensuality* and *ill
will*. The whole domain (scope) of unwholesome.[^141] And that’s why
that <span lang="pi">*samadhi*</span> further results in complete
...
choices one makes throughout one’s life.[^142]
...
authorities is inevitable[^143]. An authority is here meant in a rather
...
to impossible, though not *entirely* impossible.[^144]
...
responsibility for that choice, without resenting the authority.[^145]
...
[^3]: For a <span lang="pi">\_puthujjana-</span> it is not enough to see
...
[^4]: Cf. Maurice Merleau-Ponty, in his <cite>Phenomenology of
...
[^10]: Compare this passage from J.P. Sartre—<cite>Existentialism is
...
[^15]: Martin Heidegger, <cite>Being and Time</cite>, translated by J.
...
[^35]: <span lang="pi">*Upādāna*</span> is defined by the <cite>PTS
...
[^38]: For more on this subject see <cite>CtP</cite>, L. 93, pp. 351f.
    It is not possible to clarify the point any further, simply because
    of the nature of the subject. When one reflects, in a strict sense
...
[^39]: <cite>NoD</cite>, FUNDAMENTAL STRUCTURE , Static Aspect, §16.

[^40]: <span lang="pi">*Yena yena hi maññanti, tato taṃ hoti
    aññathā*</span>, “In whatever terms they conceive it, it turns into
    something other than that.” (<cite>Sn 3.12</cite>)

[^41]: This is achieved in the practice of
    <span lang="pi">*jhāna*</span>, which, however, will not concern us
    here.

[^42]: <cite>NoD</cite>, FUNDAMENTAL STRUCTURE , Static Aspect, §16.

[^43]: “It is in the nature of the
...
[^47]: Only an <span lang="pi">*arahat*</span> is completely free from
...
[^51]: <cite>Uddhesavibhanga Sutta, MN 138. \[iii,225\]</cite>

[^52]: They would only do so in the <span lang="pi">arahant</span>’s
    case.

[^53]: <cite>Madhupiṇḍika Sutta, MN 18</cite>; translation taken from
...
[^54]: Compare also the nature of the five hindrances. It takes the
    first <span lang="pi">jhāna</span> for one to be able to suppress
    them, which speaks for itself, since such strength of one’s
    concentration is enough for becoming an arahant (if there is wisdom,
    of course).
...
[^56]: Compare Ven. Sāriputta’s answer to Ven. Udāyi when the later
    ...
    \[in <span lang="pi">nibbāna</span>\]: “Just this is pleasant,
    friend, that herein there is nothing felt” — <cite>AN iv,414</cite>.

[^57]: Ñāṇavīra Thera took <span lang="pi">sabbatopabhaṃ</span> to be
...
[^60]: Cf. “There is just this body and name-and-form externally…” —
    <cite>SN 12.19</cite>.
...
[^63]: The reader might notice that Ñāṇavīra Thera in ‘Fundamental
    ...
    from the <span lang="pi">puthujjana</span>’s appropriation of it
    (eternity).

[^64]: Cf. <cite>AN 3.115</cite> & <cite>SN 35.202</cite>.

[^65]: Cf. <span lang="pi">*nibbānadhātu*</span>
...
[^67]: For these very reasons the Buddha was able to “rediscover” the
    path which lay there. For more cf. <cite>SN 12.65</cite>.

[^68]: Cf. Ñāṇavīra Thera, <cite>Clearing the Path</cite>, SAÑÑĀ, §2.

[^69]: Or how to not-conceive ‘that because of which’ perception is.

[^70]: Thinking it in isolation from the present experience (i.e. from
...
[^71]: The \[sense of\] independence is the inevitable outcome of the
...
[^72]: Thus, because of this assumption, one feels the thing, not one’s
...
[^73]: Cf. my essay Determining Determinations. ‘That because of which’
    \[feeling, perception, consciousness are\] is assumed as ‘that
    which’ feeling, perception, consciousness ‘are’.

[^74]: “It is not possible to separate them and by separating them point
    out the difference…” — <cite>MN 43</cite>.

[^75]: Cf. <cite>MN 43</cite>.

[^76]: Or cross into each other’s domains.

[^77]: All of these are forms of identity.

[^78]: Cf. my essay <cite>The Infinity of Mind</cite>.

[^79]: By understanding this structural ‘indifference’, one feels
    indifferent to the whole structure-which is what upekkhā is.

[^80]: It is the nature of the superimposition that breeds this
    indifference, since concern is in its nature always in relation to
    something.

[^81]: Disagreeable (or agreeable, or neutral)

[^82]: In the past, or possible in the future, or standing there in the
    present.

[^83]: Matter matters, feeling feels, perception perceives,
    determinations determine, consciousness cognizes.

[^84]: <span lang="pi">Upādānapaccayā bhavo</span>.

[^85]: ‘Name’ assumes existence in ‘matter’-‘name’ exists.

[^86]: ‘Matter’ finds footing in ‘name’-‘matter’ exists.Cf. DN 11.
...
[^88]: Cf. Ñāṇavīra Thera, <cite>Seeking The Path</cite>, 2010, p. 40,
    §§17-18: “\[Four mahābhutā\]…will always be just below our feet.”

[^89]: Thus, ‘matter’ can never be perceived, but it can “find footing”
    in that which is perceived (or felt, or intended).

[^90]: He delights in his own creation, because it is his own creation.

[^91]: If one is not to conceive that ‘matter’ because of which there is
...
[^92]: That’s how the sense of the ‘mine’ leads to the sense of ‘Self’.

[^93]: Cf. <cite>Bāhiya Sutta, Ud. 10/8</cite>.

[^94]: “Wisdom is to be developed…” — <cite>MN 43</cite>.

[^95]: If it were fundamentally subject to one’s conceivings, freedom
    from conceivings would not be possible. Cf. my The Infinity of the
    Mind

[^96]: “…consciousness is to be understood”. — <cite>MN 43</cite>.

[^97]: Simultaneous, superimposed, utterly indifferent to each other.

[^98]: Cf. <cite>MN 43</cite>.

[^99]: Cf. <cite>Notes on DN 15</cite>.

[^100]: Now is probably the time to mention that none of this, nor
...
[^101]: Cf. <cite>Khanda Saṃyutta viii,7</cite>.

[^102]: And not that because of which feeling, perception and cognizance
    are there.
...
[^105]: One knows that whether one intends toward, away, both or
...
[^106]: Does not “stand for it” in one’s experience, does not “represent
    it”, does not “manifest it”.

[^107]: Cannot be ‘accessed’ by it.

[^108]: The assumption is made redundant.

[^109]: If one thinks “there is that because of which intentions are
...
[^110]: The only reason why assumption can be made redundant, is because
...
[^111]: Which is why in order to correctly do any of the practices found
    in the Suttas, one needs the right view first.

[^112]: Cf. Ñāṇavīra Thera, <cite>Clearing the Path</cite>, p. 195.

[^113]: As recommended in <cite>SN 54:9</cite>.

[^114]: Whether it is “I am breathing in,” or “I shall breathe in,”
...
[^115]: Cf. <cite>MN 10</cite>.

[^116]: This should not be mistaken as “sensations”. See below.

[^117]: The same principle applies to the other foundations,
    namely—feelings, mind and thoughts.

[^118]: That which is simultaneously present, but “less” there, less
    actual.

[^119]: Or: “Right in front of us”; to “take them up.”

[^120]: This doesn’t mean that any (i.e. fall sorts of contradictory)
...
[^121]: Which inevitably acquired countless mystical connotations that
    they maintain to this day.

[^122]: Cf. <cite>SN 54:8</cite>.

[^123]: Cf. <cite>SN 40:1</cite>.

[^124]: Cf. <cite>MN 119</cite>

[^125]: Cf. <cite>SN 54:8</cite>.

[^126]: Cf. <cite>Sn 1:3,21</cite> (verse 55).

[^127]: Cf. Ñāṇavīra Thera, <cite>Clearing the Path</cite>, p. 75.

[^128]: In other words, it is impossible to perform an action which in
...
[^129]: And one also comes to realize that for as long as one is alive,
...
[^130]: People themselves might often struggle to reconcile the nature
...
[^131]: One can be ignorant of the phenomenological nature only because
    that nature is there, present.

[^132]: Cf. my essay Not Perceiving the Feeling (<cite>Meanings</cite>,
    p. 43) where I said that it is the feeling that feels, perception
    that perceives and thought that thinks (I am paraphrasing).

[^133]: This is a type of structural indifference and this can be
...
[^134]: And this very indifference was obscured through the assumption
...
[^136]: This is why the correct practice of mindfulness results in
    higher establishments of mind (<span lang="pi">*samadhi*</span>).
    For example, this is where mind surmounts the fundamental
    “generality” of form, by the way of surmounting the generality of
    earth, water, fire and air. Also, there is a reason that the order
    of elements always stays the same. They are have a particular
    structural order of their generality. And one can discern them in
    that order only.

[^137]: That’s also why this type of attention is said by the Buddha to
    be one of the necessary pre-requisites for the arising of the Right
    view.

[^138]: “…or mindfulness that”there is body” is simply established in
    him to the extent necessary for the final knowledge.” — <cite>MN 10,
...
[^140]: Experience as a whole, the
    ‘foreground-without-focusing-on-particular-object-witin-it’.

[^141]: Sensuality is *always* concerned with the particular content of
...
[^142]: Hence the fully developed knowledge that came from the Right
    View, results in freeing an individual from his actions
...
[^143]: ‘you’re gonna have to serve somebody, yes indeed’ — Bob Dylan

[^144]: The requirement is pretty much that such a community should be a
...
[^145]: Actually, if this is taken to its conclusion such an authority
