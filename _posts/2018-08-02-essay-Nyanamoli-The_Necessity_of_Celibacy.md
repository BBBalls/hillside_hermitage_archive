...
>
> — <cite>Anguttara Nikaya, 7.50</cite>
...
anxieties, lack of satisfaction, guilt over things done in the past—all
of that would disappear or be significantly removed. Of course, we can
only imagine what greater freedom can be gained, if on top of the
