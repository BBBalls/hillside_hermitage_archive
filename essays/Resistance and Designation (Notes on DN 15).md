...
matter body[^1^](#fn1){#fnref1 .footnote-ref}. In this way one's
...
> 'matter'.[^2^](#fn2){#fnref2 .footnote-ref}
>
...
> 'name'.[^3^](#fn3){#fnref3 .footnote-ref}
>
...
is one's own perception of that 'matter'.[^4^](#fn4){#fnref4
.footnote-ref} This is saying nothing else than 'matter' is and will
*always be outside* of one's reach, outside of that which has
appeared.[^5^](#fn5){#fnref5 .footnote-ref} Perception is that which is
...
he "makes" that 'matter' *exist*.[^6^](#fn6){#fnref6 .footnote-ref} That
"creation" is *his-*thus it is '*my*' 'matter'.[^7^](#fn7){#fnref7
.footnote-ref} But, since that 'my matter' is conceived as that 'matter'
*because of which* there is a percept of matter, then that
percept\[ion\] too becomes '*my perception'.[^8^](#fn8){#fnref8
.footnote-ref}* The same goes for one's feelings and intentions. They
are all conceived as *mine*. Since the *puthujjana's* whole experience
is *his*, he thinks he *himself* *is-*the view of Self
exists.[^9^](#fn9){#fnref9 .footnote-ref}
...
namely-the seen (and so on for all the senses).[^10^](#fn10){#fnref10
.footnote-ref} One ceases to "perceive 'matter"'; one
*knows*[^11^](#fn11){#fnref11 .footnote-ref} such a thing is impossible
or *inconceivable*,[^12^](#fn12){#fnref12 .footnote-ref} one simply
*understands*[^13^](#fn13){#fnref13 .footnote-ref}: *there is* matter,
*there is* perception (or feeling, or intention), *there is*
(non-indicative) consciousness. One *understands-*there are five
"heaps".[^14^](#fn14){#fnref14 .footnote-ref} Since one understands
them, one ceases to *assume* them. With the cessation of assumption,
...
1.  ::: {#fn1}
    Upādānapaccayā bhavo.[↩︎](#fnref1){.footnote-back}
    :::

2.  ::: {#fn2}
    'Name' assumes existence in 'matter'-'name'
    exists.[↩︎](#fnref2){.footnote-back}
    :::

3.  ::: {#fn3}
    'Matter' finds footing in 'name'-'matter' exists.Cf. DN
    11.[↩︎](#fnref3){.footnote-back}
    :::
...
4.  ::: {#fn4}
    ...
    required.)"-Ñāṇavīra Thera, Clearing the Path, 2010,
    p. 92.[↩︎](#fnref4){.footnote-back}
    :::

5.  ::: {#fn5}
    Cf. Ñāṇavīra Thera, Seeking The Path, 2010, p. 40, §§17-18: "\[Four
    mahābhutā\]...will always be just below our
    feet."[↩︎](#fnref5){.footnote-back}
    :::

6.  ::: {#fn6}
    Thus, 'matter' can never be perceived, but it can "find footing" in
    that which is perceived (or felt, or
    intended).[↩︎](#fnref6){.footnote-back}
    :::

7.  ::: {#fn7}
    He delights in his own creation, because it is his own
    creation.[↩︎](#fnref7){.footnote-back}
    :::

8.  ::: {#fn8}
    If one is not to conceive that 'matter' because of which there is a
    ...
    am', by which 'I am a conceiver of the
    world'.[↩︎](#fnref8){.footnote-back}
    :::

9.  ::: {#fn9}
    That's how the sense of the 'mine' leads to the sense of
    'Self'.[↩︎](#fnref9){.footnote-back}
    :::

10. ::: {#fn10}
    Cf. Bāhiya Sutta, Ud. 10/8.[↩︎](#fnref10){.footnote-back}
    :::

11. ::: {#fn11}
    "Wisdom is to be developed..."-MN 43.[↩︎](#fnref11){.footnote-back}
    :::

12. ::: {#fn12}
    If it were fundamentally subject to one's conceivings, freedom from
    conceivings would not be possible. Cf. my
    .[↩︎](#fnref12){.footnote-back}
    :::

13. ::: {#fn13}
    "...consciousness is to be understood".-MN
    43.[↩︎](#fnref13){.footnote-back}
    :::

14. ::: {#fn14}
    Simultaneous, superimposed, utterly indifferent to each
    other.[↩︎](#fnref14){.footnote-back}
    :::
:::
